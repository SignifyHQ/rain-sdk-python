...
from ..types import signature_retrieve_payment_signature_params, signature_retrieve_withdrawal_signature_params
...
class SignaturesResource(SyncAPIResource):
    ...
    def retrieve_payment_signature(
        ...
        *,
        ...
        """This endpoint retrieves the payment signature for an authorized user tenant.
