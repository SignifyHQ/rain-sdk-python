...
from rain_hello_world.types.applications import IssuingUser, IssuingCompany
...
class TestCompanies:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_charge(self, client: RainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_charge(self, client: RainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_charge(self, client: RainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_charge(self, client: RainHelloWorld) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_create_user(self, client: RainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_create_user_with_all_params(self, client: RainHelloWorld) -> None:
        company = client.companies.create_user(
            company_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            email="email",
            first_name="firstName",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_create_user(self, client: RainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_create_user(self, client: RainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_path_params_create_user(self, client: RainHelloWorld) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
...
class TestAsyncCompanies:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_charge(self, async_client: AsyncRainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_charge(self, async_client: AsyncRainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_charge(self, async_client: AsyncRainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_charge(self, async_client: AsyncRainHelloWorld) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_create_user(self, async_client: AsyncRainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_create_user_with_all_params(self, async_client: AsyncRainHelloWorld) -> None:
        company = await async_client.companies.create_user(
            company_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            email="email",
            first_name="firstName",
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_create_user(self, async_client: AsyncRainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_create_user(self, async_client: AsyncRainHelloWorld) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_path_params_create_user(self, async_client: AsyncRainHelloWorld) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
