...
class TestSignatures:
    ...
    def test_method_retrieve_payment_signature(self, client: RainHelloWorld) -> None:
        signature = client.users.signatures.retrieve_payment_signature(
    ...
    def test_raw_response_retrieve_payment_signature(self, client: RainHelloWorld) -> None:
        response = client.users.signatures.with_raw_response.retrieve_payment_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    def test_streaming_response_retrieve_payment_signature(self, client: RainHelloWorld) -> None:
        with client.users.signatures.with_streaming_response.retrieve_payment_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    def test_path_params_retrieve_payment_signature(self, client: RainHelloWorld) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            client.users.signatures.with_raw_response.retrieve_payment_signature(
                user_id="",
                token="token",
                admin_address="adminAddress",
                amount="amount",
    ...
    def test_raw_response_retrieve_withdrawal_signature(self, client: RainHelloWorld) -> None:
        response = client.users.signatures.with_raw_response.retrieve_withdrawal_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    def test_streaming_response_retrieve_withdrawal_signature(self, client: RainHelloWorld) -> None:
        with client.users.signatures.with_streaming_response.retrieve_withdrawal_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    def test_path_params_retrieve_withdrawal_signature(self, client: RainHelloWorld) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            client.users.signatures.with_raw_response.retrieve_withdrawal_signature(
                user_id="",
                token="token",
                admin_address="adminAddress",
                amount="amount",
...
class TestAsyncSignatures:
    ...
    async def test_method_retrieve_payment_signature(self, async_client: AsyncRainHelloWorld) -> None:
        signature = await async_client.users.signatures.retrieve_payment_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    async def test_raw_response_retrieve_payment_signature(self, async_client: AsyncRainHelloWorld) -> None:
        response = await async_client.users.signatures.with_raw_response.retrieve_payment_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    async def test_streaming_response_retrieve_payment_signature(self, async_client: AsyncRainHelloWorld) -> None:
        async with async_client.users.signatures.with_streaming_response.retrieve_payment_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    async def test_path_params_retrieve_payment_signature(self, async_client: AsyncRainHelloWorld) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            await async_client.users.signatures.with_raw_response.retrieve_payment_signature(
                user_id="",
                token="token",
                admin_address="adminAddress",
                amount="amount",
    ...
    async def test_method_retrieve_withdrawal_signature(self, async_client: AsyncRainHelloWorld) -> None:
        signature = await async_client.users.signatures.retrieve_withdrawal_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    async def test_raw_response_retrieve_withdrawal_signature(self, async_client: AsyncRainHelloWorld) -> None:
        response = await async_client.users.signatures.with_raw_response.retrieve_withdrawal_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    async def test_streaming_response_retrieve_withdrawal_signature(self, async_client: AsyncRainHelloWorld) -> None:
        async with async_client.users.signatures.with_streaming_response.retrieve_withdrawal_signature(
            user_id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
            token="token",
            admin_address="adminAddress",
            amount="amount",
    ...
    async def test_path_params_retrieve_withdrawal_signature(self, async_client: AsyncRainHelloWorld) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `user_id` but received ''"):
            await async_client.users.signatures.with_raw_response.retrieve_withdrawal_signature(
                user_id="",
                token="token",
                admin_address="adminAddress",
                amount="amount",
